...
var
    ...
    begin
        assign(ausuarios,'/work/archivousuariovalentinalakx.dat');
        assign(ahistorias,'/work/archivohistoriasvalentinalakx.dat');
        assign(aseguidos,'/work/archivoseguidosvalentinalakx.dat');		
        if (fileexists('/work/archivousuariovalentinalakx.dat')) and (fileexists('/work/archivohistoriasvalentinalakx.dat')) and (fileexists('/work/archivoseguidosvalentinalakx.dat')) then
            begin
                reset(ausuarios);
                reset(aseguidos);
                reset(ahistorias);
            end;
        if (not fileexists('/work/archivousuariovalentinalakx.dat')) and (not fileexists('/work/archivousuariovalentinalakx.dat')) and (not fileexists('/work/archivoseguidosvalentinalakx.dat')) then
            begin	
                rewrite(ausuarios);
                rewrite(aseguidos);
                rewrite(ahistorias);
